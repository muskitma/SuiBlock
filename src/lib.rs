...
#[derive(Debug)]
pub struct SuiBlockProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SuiBlockProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SuiBlock processing");
    
    let mut processor = SuiBlockProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SuiBlockProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SuiBlockProcessor::new(false);
